...
# Since there may be outliers of students with many absences, use the median function that
# we've imported from numpy to display the median number of absences instead of the average.
